...
if {[file isfile matrixAvg.autotvin.dat]} {
	file delete -force matrixAvg.autotvin.dat
}

if {[file isfile matrixAvg.autotvout.dat]} {
	file delete -force matrixAvg.autotvout.dat
}
