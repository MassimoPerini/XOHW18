...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixAvg.autotvin_agg_result_red.dat"
         "c.matrixAvg.autotvin_agg_result_blue.dat"
         "c.matrixAvg.autotvin_agg_result_green.dat"
         "c.matrixAvg.autotvin_input_red.dat"
         "c.matrixAvg.autotvin_input_blue.dat"
         "c.matrixAvg.autotvin_input_green.dat"
         "c.matrixAvg.autotvout_agg_result_red.dat"
         "c.matrixAvg.autotvout_agg_result_blue.dat"
         "c.matrixAvg.autotvout_agg_result_green.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixAvg.autotvout_agg_result_red.dat"
         "rtl.matrixAvg.autotvout_agg_result_blue.dat"
         "rtl.matrixAvg.autotvout_agg_result_green.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
