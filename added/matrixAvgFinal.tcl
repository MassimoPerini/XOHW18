...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: matrixAvg_0, and set properties
  set matrixAvg_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrixAvg:1.0 matrixAvg_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrixAvg_0/mat_in]
  ...
  connect_bd_intf_net -intf_net matrixAvg_0_mat_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matrixAvg_0/mat_out]
