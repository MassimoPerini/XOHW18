...
set ::env(LD_LIBRARY_PATH) /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixAvg.autotvin.dat"
	set constFileTvOut       "matrixAvg.autotvout.dat"
	set constFileHdlTvIn     "matrixAvg.autohdltvin.dat"
	set constFileHdlTvOut    "matrixAvg.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
