...
AUTOPILOT_ROOT := /xilinx/software/Vivado_HLS/2017.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /xilinx/software/Vivado_HLS/2017.2/lnx64/tools/gcc/bin
endif
CCFLAG += 
...
$(ObjDir)/matrixTestB.c_pre.c.tb.o : matrixTestB.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) matrixTestB.c_pre.c.tb.c" $(AVE_DIR_DLOG)
