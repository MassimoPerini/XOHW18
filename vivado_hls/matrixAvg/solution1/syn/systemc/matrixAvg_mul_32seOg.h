...
#ifndef __matrixAvg_mul_32seOg__HH__
#define __matrixAvg_mul_32seOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrixAvg_mul_32seOg) {
    ...
    SC_CTOR(matrixAvg_mul_32seOg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
