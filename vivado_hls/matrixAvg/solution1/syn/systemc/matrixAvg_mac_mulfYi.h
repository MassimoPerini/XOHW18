...
#ifndef __matrixAvg_mac_mulfYi__HH__
#define __matrixAvg_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrixAvg_mac_mulfYi) {
    ...
    SC_CTOR(matrixAvg_mac_mulfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
