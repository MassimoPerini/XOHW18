...
@matrixAvg.str = internal unnamed_addr constant [10 x i8] c"matrixAvg\00" ; [#uses=1 type=[10 x i8]*]
...
@.str2 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=17 type=[1 x i8]*]
...
; [#uses=0]
define void @matrixAvg(i32* %mat_in.V.data.V, i4* %mat_in.V.keep.V, i4* %mat_in.V.strb.V, i1* %mat_in.V.user.V, i1* %mat_in.V.last.V, i1* %mat_in.V.id.V, i1* %mat_in.V.dest.V, i32* %mat_out.V.data.V, i4* %mat_out.V.keep.V, i4* %mat_out.V.strb.V, i1* %mat_out.V.user.V, i1* %mat_out.V.last.V, i1* %mat_out.V.id.V, i1* %mat_out.V.dest.V) {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %mat_in.V.data.V), !map !4370
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %mat_in.V.keep.V), !map !4374
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %mat_in.V.strb.V), !map !4378
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_in.V.user.V), !map !4382
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_in.V.last.V), !map !4386
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_in.V.id.V), !map !4390
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_in.V.dest.V), !map !4394
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %mat_out.V.data.V), !map !4398
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %mat_out.V.keep.V), !map !4402
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %mat_out.V.strb.V), !map !4406
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_out.V.user.V), !map !4410
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_out.V.last.V), !map !4414
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_out.V.id.V), !map !4418
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %mat_out.V.dest.V), !map !4422
  call void (...)* @_ssdm_op_SpecTopModule([10 x i8]* @matrixAvg.str) nounwind
  %tmp.data.V.5 = alloca i32, align 4             ; [#uses=2 type=i32*]
  %tmp.keep.V.5 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.strb.V.5 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.user.V.5 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.last.V.5 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.id.V.5 = alloca i1, align 1                ; [#uses=2 type=i1*]
  %tmp.dest.V.5 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.data.V.4 = alloca i32, align 4             ; [#uses=2 type=i32*]
  %tmp.keep.V.4 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.strb.V.4 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.user.V.4 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.last.V.4 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.id.V.4 = alloca i1, align 1                ; [#uses=2 type=i1*]
  %tmp.dest.V.4 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.data.V.3 = alloca i32, align 4             ; [#uses=2 type=i32*]
  %tmp.keep.V.3 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.strb.V.3 = alloca i4, align 1              ; [#uses=2 type=i4*]
  %tmp.user.V.3 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.last.V.3 = alloca i1, align 1              ; [#uses=2 type=i1*]
  %tmp.id.V.3 = alloca i1, align 1                ; [#uses=2 type=i1*]
  %tmp.dest.V.3 = alloca i1, align 1              ; [#uses=2 type=i1*]
  ...
  %cell_avg.red = alloca [9 x i32], align 4       ; [#uses=2 type=[9 x i32]*]
  %cell_avg.blue = alloca [9 x i32], align 4      ; [#uses=2 type=[9 x i32]*]
  %cell_avg.green = alloca [9 x i32], align 4     ; [#uses=2 type=[9 x i32]*]
  ...
  %tmp.keep.V.1 = alloca i4, align 1              ; [#uses=1 type=i4*]
  %tmp.strb.V.1 = alloca i4, align 1              ; [#uses=1 type=i4*]
  %tmp.user.V.1 = alloca i1, align 1              ; [#uses=1 type=i1*]
  %tmp.last.V.1 = alloca i1, align 1              ; [#uses=1 type=i1*]
  %tmp.id.V.1 = alloca i1, align 1                ; [#uses=1 type=i1*]
  %tmp.dest.V.1 = alloca i1, align 1              ; [#uses=1 type=i1*]
  %tmp.data.V.2 = alloca i32, align 4             ; [#uses=2 type=i32*]
  %tmp.keep.V.2 = alloca i4, align 1              ; [#uses=1 type=i4*]
  %tmp.strb.V.2 = alloca i4, align 1              ; [#uses=1 type=i4*]
  %tmp.user.V.2 = alloca i1, align 1              ; [#uses=1 type=i1*]
  %tmp.last.V.2 = alloca i1, align 1              ; [#uses=1 type=i1*]
  %tmp.id.V.2 = alloca i1, align 1                ; [#uses=1 type=i1*]
  %tmp.dest.V.2 = alloca i1, align 1              ; [#uses=1 type=i1*]
  call void @llvm.dbg.value(metadata !{i32* %mat_in.V.data.V}, i64 0, metadata !4426), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.keep.V}, i64 0, metadata !4440), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.strb.V}, i64 0, metadata !4452), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.user.V}, i64 0, metadata !4453), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.last.V}, i64 0, metadata !4465), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.id.V}, i64 0, metadata !4466), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.dest.V}, i64 0, metadata !4467), !dbg !4439 ; [debug line = 41:40] [debug variable = mat_in.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32* %mat_out.V.data.V}, i64 0, metadata !4468), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.keep.V}, i64 0, metadata !4471), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.strb.V}, i64 0, metadata !4472), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.user.V}, i64 0, metadata !4473), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.last.V}, i64 0, metadata !4474), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.id.V}, i64 0, metadata !4475), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.dest.V}, i64 0, metadata !4476), !dbg !4470 ; [debug line = 41:72] [debug variable = mat_out.V.dest.V]
  call void (...)* @_ssdm_op_SpecInterface(i32* %mat_in.V.data.V, i4* %mat_in.V.keep.V, i4* %mat_in.V.strb.V, i1* %mat_in.V.user.V, i1* %mat_in.V.last.V, i1* %mat_in.V.id.V, i1* %mat_in.V.dest.V, [5 x i8]* @.str, i32 1, i32 1, [5 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2, [1 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2) nounwind, !dbg !4477 ; [debug line = 43:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %mat_out.V.data.V, i4* %mat_out.V.keep.V, i4* %mat_out.V.strb.V, i1* %mat_out.V.user.V, i1* %mat_out.V.last.V, i1* %mat_out.V.id.V, i1* %mat_out.V.dest.V, [5 x i8]* @.str, i32 1, i32 1, [5 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2, [1 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2) nounwind, !dbg !4479 ; [debug line = 44:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [13 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str2, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2, [1 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str2, [1 x i8]* @.str2) nounwind, !dbg !4480 ; [debug line = 45:1]
  call void @llvm.dbg.declare(metadata !{[900 x i32]* %red}, metadata !4481), !dbg !4485 ; [debug line = 48:6] [debug variable = red]
  call void @llvm.dbg.declare(metadata !{[900 x i32]* %green}, metadata !4486), !dbg !4487 ; [debug line = 49:9] [debug variable = green]
  call void @llvm.dbg.declare(metadata !{[900 x i32]* %blue}, metadata !4488), !dbg !4489 ; [debug line = 50:9] [debug variable = blue]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %cell_avg.red}, metadata !4490), !dbg !4507 ; [debug line = 51:13] [debug variable = cell_avg.red]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %cell_avg.blue}, metadata !4508), !dbg !4507 ; [debug line = 51:13] [debug variable = cell_avg.blue]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %cell_avg.green}, metadata !4511), !dbg !4507 ; [debug line = 51:13] [debug variable = cell_avg.green]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %sum_red}, metadata !4514), !dbg !4515 ; [debug line = 54:9] [debug variable = sum_red]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %sum_blue}, metadata !4516), !dbg !4517 ; [debug line = 55:9] [debug variable = sum_blue]
  call void @llvm.dbg.declare(metadata !{[9 x i32]* %sum_green}, metadata !4518), !dbg !4519 ; [debug line = 56:9] [debug variable = sum_green]
  br label %1, !dbg !4520                         ; [debug line = 59:9]

; <label>:1                                       ; preds = %3, %0
  %i = phi i10 [ 0, %0 ], [ %i.6, %3 ]            ; [#uses=3 type=i10]
  %tmp = icmp eq i10 %i, -124, !dbg !4520         ; [#uses=1 type=i1] [debug line = 59:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 900, i64 900, i64 900) ; [#uses=0 type=i32]
  br i1 %tmp, label %.preheader22.preheader, label %3, !dbg !4520 ; [debug line = 59:9]

.preheader22.preheader:                           ; preds = %1
  br label %.preheader22, !dbg !4522              ; [debug line = 66:9]

; <label>:3                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32* %mat_in.V.data.V}, i64 0, metadata !4524), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.keep.V}, i64 0, metadata !4531), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.strb.V}, i64 0, metadata !4533), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.user.V}, i64 0, metadata !4534), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.last.V}, i64 0, metadata !4536), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.id.V}, i64 0, metadata !4537), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.dest.V}, i64 0, metadata !4538), !dbg !4528 ; [debug line = 129:56@61:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V}, metadata !4539), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V}, metadata !4543), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V}, metadata !4544), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V}, metadata !4545), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V}, metadata !4546), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V}, metadata !4547), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V}, metadata !4548), !dbg !4542 ; [debug line = 130:22@61:29] [debug variable = tmp.dest.V]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_in.V.data.V, i4* %mat_in.V.keep.V, i4* %mat_in.V.strb.V, i1* %mat_in.V.user.V, i1* %mat_in.V.last.V, i1* %mat_in.V.id.V, i1* %mat_in.V.dest.V, i32* %tmp.data.V, i4* %tmp.keep.V, i4* %tmp.strb.V, i1* %tmp.user.V, i1* %tmp.last.V, i1* %tmp.id.V, i1* %tmp.dest.V), !dbg !4549 ; [debug line = 131:9@61:29]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V}, i64 0, metadata !4539), !dbg !4550 ; [debug line = 1667:70@61:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V}, i64 0, metadata !4539), !dbg !4550 ; [debug line = 1667:70@61:29] [debug variable = tmp.data.V]
  %tmp.data.V.load = load i32* %tmp.data.V, align 4, !dbg !4550 ; [#uses=1 type=i32] [debug line = 1667:70@61:29]
  %tmp.2 = zext i10 %i to i64, !dbg !4552         ; [#uses=1 type=i64] [debug line = 63:9]
  %red.addr = getelementptr inbounds [900 x i32]* %red, i64 0, i64 %tmp.2, !dbg !4552 ; [#uses=1 type=i32*] [debug line = 63:9]
  store i32 %tmp.data.V.load, i32* %red.addr, align 4, !dbg !4552 ; [debug line = 63:9]
  %i.6 = add i10 %i, 1, !dbg !4553                ; [#uses=1 type=i10] [debug line = 59:19]
  call void @llvm.dbg.value(metadata !{i10 %i.6}, i64 0, metadata !4554), !dbg !4553 ; [debug line = 59:19] [debug variable = i]
  br label %1, !dbg !4553                         ; [debug line = 59:19]

.preheader22:                                     ; preds = %5, %.preheader22.preheader
  %i.1 = phi i10 [ %i.7, %5 ], [ 0, %.preheader22.preheader ] ; [#uses=3 type=i10]
  %tmp.4 = icmp eq i10 %i.1, -124, !dbg !4522     ; [#uses=1 type=i1] [debug line = 66:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 900, i64 900, i64 900) ; [#uses=0 type=i32]
  br i1 %tmp.4, label %.preheader21.preheader, label %5, !dbg !4522 ; [debug line = 66:9]

.preheader21.preheader:                           ; preds = %.preheader22
  br label %.preheader21, !dbg !4555              ; [debug line = 72:9]

; <label>:5                                       ; preds = %.preheader22
  call void @llvm.dbg.value(metadata !{i32* %mat_in.V.data.V}, i64 0, metadata !4524), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.keep.V}, i64 0, metadata !4531), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.strb.V}, i64 0, metadata !4533), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.user.V}, i64 0, metadata !4534), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.last.V}, i64 0, metadata !4536), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.id.V}, i64 0, metadata !4537), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.dest.V}, i64 0, metadata !4538), !dbg !4557 ; [debug line = 129:56@68:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V.1}, metadata !4539), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V.1}, metadata !4543), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V.1}, metadata !4544), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V.1}, metadata !4545), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V.1}, metadata !4546), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V.1}, metadata !4547), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V.1}, metadata !4548), !dbg !4560 ; [debug line = 130:22@68:29] [debug variable = tmp.dest.V]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_in.V.data.V, i4* %mat_in.V.keep.V, i4* %mat_in.V.strb.V, i1* %mat_in.V.user.V, i1* %mat_in.V.last.V, i1* %mat_in.V.id.V, i1* %mat_in.V.dest.V, i32* %tmp.data.V.1, i4* %tmp.keep.V.1, i4* %tmp.strb.V.1, i1* %tmp.user.V.1, i1* %tmp.last.V.1, i1* %tmp.id.V.1, i1* %tmp.dest.V.1), !dbg !4561 ; [debug line = 131:9@68:29]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V.1}, i64 0, metadata !4539), !dbg !4562 ; [debug line = 1667:70@68:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V.1}, i64 0, metadata !4539), !dbg !4562 ; [debug line = 1667:70@68:29] [debug variable = tmp.data.V]
  %tmp.data.V.1.load = load i32* %tmp.data.V.1, align 4, !dbg !4562 ; [#uses=1 type=i32] [debug line = 1667:70@68:29]
  %tmp.6 = zext i10 %i.1 to i64, !dbg !4563       ; [#uses=1 type=i64] [debug line = 69:9]
  %green.addr = getelementptr inbounds [900 x i32]* %green, i64 0, i64 %tmp.6, !dbg !4563 ; [#uses=1 type=i32*] [debug line = 69:9]
  store i32 %tmp.data.V.1.load, i32* %green.addr, align 4, !dbg !4563 ; [debug line = 69:9]
  %i.7 = add i10 %i.1, 1, !dbg !4564              ; [#uses=1 type=i10] [debug line = 66:19]
  call void @llvm.dbg.value(metadata !{i10 %i.7}, i64 0, metadata !4554), !dbg !4564 ; [debug line = 66:19] [debug variable = i]
  br label %.preheader22, !dbg !4564              ; [debug line = 66:19]

.preheader21:                                     ; preds = %7, %.preheader21.preheader
  %i.2 = phi i10 [ %i.8, %7 ], [ 0, %.preheader21.preheader ] ; [#uses=3 type=i10]
  %tmp.8 = icmp eq i10 %i.2, -124, !dbg !4555     ; [#uses=1 type=i1] [debug line = 72:9]
  %6 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 900, i64 900, i64 900) ; [#uses=0 type=i32]
  br i1 %tmp.8, label %.preheader20.preheader, label %7, !dbg !4555 ; [debug line = 72:9]

.preheader20.preheader:                           ; preds = %.preheader21
  %sum_red.addr = getelementptr inbounds [9 x i32]* %sum_red, i64 0, i64 0, !dbg !4565 ; [#uses=1 type=i32*] [debug line = 78:9]
  %sum_blue.addr = getelementptr inbounds [9 x i32]* %sum_blue, i64 0, i64 0, !dbg !4568 ; [#uses=1 type=i32*] [debug line = 79:9]
  %sum_green.addr = getelementptr inbounds [9 x i32]* %sum_green, i64 0, i64 0, !dbg !4569 ; [#uses=1 type=i32*] [debug line = 80:9]
  br label %.preheader20, !dbg !4570              ; [debug line = 77:9]

; <label>:7                                       ; preds = %.preheader21
  call void @llvm.dbg.value(metadata !{i32* %mat_in.V.data.V}, i64 0, metadata !4524), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.keep.V}, i64 0, metadata !4531), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_in.V.strb.V}, i64 0, metadata !4533), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.user.V}, i64 0, metadata !4534), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.last.V}, i64 0, metadata !4536), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.id.V}, i64 0, metadata !4537), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_in.V.dest.V}, i64 0, metadata !4538), !dbg !4571 ; [debug line = 129:56@74:29] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V.2}, metadata !4539), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V.2}, metadata !4543), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V.2}, metadata !4544), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V.2}, metadata !4545), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V.2}, metadata !4546), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V.2}, metadata !4547), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V.2}, metadata !4548), !dbg !4574 ; [debug line = 130:22@74:29] [debug variable = tmp.dest.V]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_in.V.data.V, i4* %mat_in.V.keep.V, i4* %mat_in.V.strb.V, i1* %mat_in.V.user.V, i1* %mat_in.V.last.V, i1* %mat_in.V.id.V, i1* %mat_in.V.dest.V, i32* %tmp.data.V.2, i4* %tmp.keep.V.2, i4* %tmp.strb.V.2, i1* %tmp.user.V.2, i1* %tmp.last.V.2, i1* %tmp.id.V.2, i1* %tmp.dest.V.2), !dbg !4575 ; [debug line = 131:9@74:29]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V.2}, i64 0, metadata !4539), !dbg !4576 ; [debug line = 1667:70@74:29] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32* %tmp.data.V.2}, i64 0, metadata !4539), !dbg !4576 ; [debug line = 1667:70@74:29] [debug variable = tmp.data.V]
  %tmp.data.V.2.load = load i32* %tmp.data.V.2, align 4, !dbg !4576 ; [#uses=1 type=i32] [debug line = 1667:70@74:29]
  %tmp. = zext i10 %i.2 to i64, !dbg !4577        ; [#uses=1 type=i64] [debug line = 75:9]
  %blue.addr = getelementptr inbounds [900 x i32]* %blue, i64 0, i64 %tmp., !dbg !4577 ; [#uses=1 type=i32*] [debug line = 75:9]
  store i32 %tmp.data.V.2.load, i32* %blue.addr, align 4, !dbg !4577 ; [debug line = 75:9]
  %i.8 = add i10 %i.2, 1, !dbg !4578              ; [#uses=1 type=i10] [debug line = 72:19]
  call void @llvm.dbg.value(metadata !{i10 %i.8}, i64 0, metadata !4554), !dbg !4578 ; [debug line = 72:19] [debug variable = i]
  br label %.preheader21, !dbg !4578              ; [debug line = 72:19]

.preheader20:                                     ; preds = %9, %.preheader20.preheader
  %i.3 = phi i4 [ %i.9, %9 ], [ 0, %.preheader20.preheader ] ; [#uses=2 type=i4]
  %tmp.1 = icmp eq i4 %i.3, -7, !dbg !4570        ; [#uses=1 type=i1] [debug line = 77:9]
  %8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %tmp.1, label %.preheader19.preheader, label %9, !dbg !4570 ; [debug line = 77:9]

.preheader19.preheader:                           ; preds = %.preheader20
  br label %.preheader19, !dbg !4579              ; [debug line = 86:2]

; <label>:9                                       ; preds = %.preheader20
  store i32 0, i32* %sum_red.addr, align 16, !dbg !4565 ; [debug line = 78:9]
  store i32 0, i32* %sum_blue.addr, align 16, !dbg !4568 ; [debug line = 79:9]
  store i32 0, i32* %sum_green.addr, align 16, !dbg !4569 ; [debug line = 80:9]
  %i.9 = add i4 %i.3, 1, !dbg !4584               ; [#uses=1 type=i4] [debug line = 77:17]
  call void @llvm.dbg.value(metadata !{i4 %i.9}, i64 0, metadata !4554), !dbg !4584 ; [debug line = 77:17] [debug variable = i]
  br label %.preheader20, !dbg !4584              ; [debug line = 77:17]

.preheader19:                                     ; preds = %14, %.preheader19.preheader
  %j = phi i4 [ %j.1, %14 ], [ 0, %.preheader19.preheader ] ; [#uses=4 type=i4]
  %j.cast7 = zext i4 %j to i10, !dbg !4579        ; [#uses=1 type=i10] [debug line = 86:2]
  %exitcond1 = icmp eq i4 %j, -7, !dbg !4585      ; [#uses=1 type=i1] [debug line = 83:9]
  %10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %.preheader17.preheader, label %.preheader18.preheader, !dbg !4585 ; [debug line = 83:9]

.preheader17.preheader:                           ; preds = %.preheader19
  br label %.preheader17, !dbg !4586              ; [debug line = 92:9]

.preheader18.preheader:                           ; preds = %.preheader19
  %tmp.3 = mul i10 %j.cast7, 100, !dbg !4579      ; [#uses=1 type=i10] [debug line = 86:2]
  %tmp.5 = zext i4 %j to i64, !dbg !4579          ; [#uses=3 type=i64] [debug line = 86:2]
  %sum_red.addr.1 = getelementptr inbounds [9 x i32]* %sum_red, i64 0, i64 %tmp.5, !dbg !4579 ; [#uses=2 type=i32*] [debug line = 86:2]
  %sum_green.addr.1 = getelementptr inbounds [9 x i32]* %sum_green, i64 0, i64 %tmp.5, !dbg !4588 ; [#uses=2 type=i32*] [debug line = 87:13]
  %sum_blue.addr.1 = getelementptr inbounds [9 x i32]* %sum_blue, i64 0, i64 %tmp.5, !dbg !4589 ; [#uses=2 type=i32*] [debug line = 88:13]
  br label %.preheader18, !dbg !4590              ; [debug line = 84:13]

.preheader18:                                     ; preds = %12, %.preheader18.preheader
  %i.4 = phi i7 [ %i.11, %12 ], [ 0, %.preheader18.preheader ] ; [#uses=3 type=i7]
  %i.4.cast5 = zext i7 %i.4 to i10, !dbg !4590    ; [#uses=1 type=i10] [debug line = 84:13]
  %tmp.9 = icmp eq i7 %i.4, -28, !dbg !4590       ; [#uses=1 type=i1] [debug line = 84:13]
  %11 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 100, i64 100, i64 100) ; [#uses=0 type=i32]
  br i1 %tmp.9, label %14, label %12, !dbg !4590  ; [debug line = 84:13]

; <label>:12                                      ; preds = %.preheader18
  %tmp.22 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str4), !dbg !4591 ; [#uses=1 type=i32] [debug line = 84:28]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !4592 ; [debug line = 85:1]
  %tmp.14 = add i10 %tmp.3, %i.4.cast5, !dbg !4579 ; [#uses=1 type=i10] [debug line = 86:2]
  %tmp.15 = zext i10 %tmp.14 to i64, !dbg !4579   ; [#uses=3 type=i64] [debug line = 86:2]
  %red.addr.1 = getelementptr inbounds [900 x i32]* %red, i64 0, i64 %tmp.15, !dbg !4579 ; [#uses=1 type=i32*] [debug line = 86:2]
  %red.load = load i32* %red.addr.1, align 4, !dbg !4579 ; [#uses=1 type=i32] [debug line = 86:2]
  %sum_red.load.1 = load i32* %sum_red.addr.1, align 4, !dbg !4579 ; [#uses=1 type=i32] [debug line = 86:2]
  %tmp.16 = add nsw i32 %red.load, %sum_red.load.1, !dbg !4579 ; [#uses=1 type=i32] [debug line = 86:2]
  store i32 %tmp.16, i32* %sum_red.addr.1, align 4, !dbg !4579 ; [debug line = 86:2]
  %green.addr.1 = getelementptr inbounds [900 x i32]* %green, i64 0, i64 %tmp.15, !dbg !4588 ; [#uses=1 type=i32*] [debug line = 87:13]
  %green.load = load i32* %green.addr.1, align 4, !dbg !4588 ; [#uses=1 type=i32] [debug line = 87:13]
  %sum_green.load.1 = load i32* %sum_green.addr.1, align 4, !dbg !4588 ; [#uses=1 type=i32] [debug line = 87:13]
  %tmp.17 = add nsw i32 %green.load, %sum_green.load.1, !dbg !4588 ; [#uses=1 type=i32] [debug line = 87:13]
  store i32 %tmp.17, i32* %sum_green.addr.1, align 4, !dbg !4588 ; [debug line = 87:13]
  %blue.addr.1 = getelementptr inbounds [900 x i32]* %blue, i64 0, i64 %tmp.15, !dbg !4589 ; [#uses=1 type=i32*] [debug line = 88:13]
  %blue.load = load i32* %blue.addr.1, align 4, !dbg !4589 ; [#uses=1 type=i32] [debug line = 88:13]
  %sum_blue.load.1 = load i32* %sum_blue.addr.1, align 4, !dbg !4589 ; [#uses=1 type=i32] [debug line = 88:13]
  %tmp.18 = add nsw i32 %blue.load, %sum_blue.load.1, !dbg !4589 ; [#uses=1 type=i32] [debug line = 88:13]
  store i32 %tmp.18, i32* %sum_blue.addr.1, align 4, !dbg !4589 ; [debug line = 88:13]
  %13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str4, i32 %tmp.22), !dbg !4593 ; [#uses=0 type=i32] [debug line = 89:9]
  %i.11 = add i7 %i.4, 1, !dbg !4594              ; [#uses=1 type=i7] [debug line = 84:23]
  call void @llvm.dbg.value(metadata !{i7 %i.11}, i64 0, metadata !4554), !dbg !4594 ; [debug line = 84:23] [debug variable = i]
  br label %.preheader18, !dbg !4594              ; [debug line = 84:23]

; <label>:14                                      ; preds = %.preheader18
  %j.1 = add i4 %j, 1, !dbg !4595                 ; [#uses=1 type=i4] [debug line = 83:17]
  call void @llvm.dbg.value(metadata !{i4 %j.1}, i64 0, metadata !4596), !dbg !4595 ; [debug line = 83:17] [debug variable = j]
  br label %.preheader19, !dbg !4595              ; [debug line = 83:17]

.preheader17:                                     ; preds = %16, %.preheader17.preheader
  %i.5 = phi i4 [ %i.10, %16 ], [ 0, %.preheader17.preheader ] ; [#uses=3 type=i4]
  %tmp.7 = icmp eq i4 %i.5, -7, !dbg !4586        ; [#uses=1 type=i1] [debug line = 92:9]
  %15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %tmp.7, label %.preheader16.preheader, label %16, !dbg !4586 ; [debug line = 92:9]

.preheader16.preheader:                           ; preds = %.preheader17
  br label %.preheader16, !dbg !4597              ; [debug line = 99:16]

; <label>:16                                      ; preds = %.preheader17
  %tmp.10 = zext i4 %i.5 to i64, !dbg !4599       ; [#uses=6 type=i64] [debug line = 93:9]
  %sum_red.addr.2 = getelementptr inbounds [9 x i32]* %sum_red, i64 0, i64 %tmp.10, !dbg !4599 ; [#uses=1 type=i32*] [debug line = 93:9]
  %sum_red.load = load i32* %sum_red.addr.2, align 4, !dbg !4599 ; [#uses=1 type=i32] [debug line = 93:9]
  %tmp.11 = sdiv i32 %sum_red.load, 100, !dbg !4599 ; [#uses=1 type=i32] [debug line = 93:9]
  %cell_avg.red.addr = getelementptr [9 x i32]* %cell_avg.red, i64 0, i64 %tmp.10, !dbg !4599 ; [#uses=1 type=i32*] [debug line = 93:9]
  store i32 %tmp.11, i32* %cell_avg.red.addr, align 4, !dbg !4599 ; [debug line = 93:9]
  %sum_green.addr.2 = getelementptr inbounds [9 x i32]* %sum_green, i64 0, i64 %tmp.10, !dbg !4601 ; [#uses=1 type=i32*] [debug line = 94:9]
  %sum_green.load = load i32* %sum_green.addr.2, align 4, !dbg !4601 ; [#uses=1 type=i32] [debug line = 94:9]
  %tmp.12 = sdiv i32 %sum_green.load, 100, !dbg !4601 ; [#uses=1 type=i32] [debug line = 94:9]
  %cell_avg.green.addr = getelementptr [9 x i32]* %cell_avg.green, i64 0, i64 %tmp.10, !dbg !4601 ; [#uses=1 type=i32*] [debug line = 94:9]
  store i32 %tmp.12, i32* %cell_avg.green.addr, align 4, !dbg !4601 ; [debug line = 94:9]
  %sum_blue.addr.2 = getelementptr inbounds [9 x i32]* %sum_blue, i64 0, i64 %tmp.10, !dbg !4602 ; [#uses=1 type=i32*] [debug line = 95:9]
  %sum_blue.load = load i32* %sum_blue.addr.2, align 4, !dbg !4602 ; [#uses=1 type=i32] [debug line = 95:9]
  %tmp.13 = sdiv i32 %sum_blue.load, 100, !dbg !4602 ; [#uses=1 type=i32] [debug line = 95:9]
  %cell_avg.blue.addr = getelementptr [9 x i32]* %cell_avg.blue, i64 0, i64 %tmp.10, !dbg !4602 ; [#uses=1 type=i32*] [debug line = 95:9]
  store i32 %tmp.13, i32* %cell_avg.blue.addr, align 4, !dbg !4602 ; [debug line = 95:9]
  %i.10 = add i4 %i.5, 1, !dbg !4603              ; [#uses=1 type=i4] [debug line = 92:17]
  call void @llvm.dbg.value(metadata !{i4 %i.10}, i64 0, metadata !4554), !dbg !4603 ; [debug line = 92:17] [debug variable = i]
  br label %.preheader17, !dbg !4603              ; [debug line = 92:17]

.preheader16:                                     ; preds = %18, %.preheader16.preheader
  %i3 = phi i4 [ %i.12, %18 ], [ 0, %.preheader16.preheader ] ; [#uses=3 type=i4]
  %exitcond2 = icmp eq i4 %i3, -7, !dbg !4597     ; [#uses=1 type=i1] [debug line = 99:16]
  %17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %.preheader15.preheader, label %18, !dbg !4597 ; [debug line = 99:16]

.preheader15.preheader:                           ; preds = %.preheader16
  br label %.preheader15, !dbg !4604              ; [debug line = 105:16]

; <label>:18                                      ; preds = %.preheader16
  %tmp.19 = zext i4 %i3 to i64, !dbg !4606        ; [#uses=1 type=i64] [debug line = 101:9]
  %cell_avg.red.addr.1 = getelementptr [9 x i32]* %cell_avg.red, i64 0, i64 %tmp.19, !dbg !4606 ; [#uses=1 type=i32*] [debug line = 101:9]
  %data.assign = load i32* %cell_avg.red.addr.1, align 4, !dbg !4606 ; [#uses=1 type=i32] [debug line = 101:9]
  call void @llvm.dbg.value(metadata !{i32 %data.assign}, i64 0, metadata !4608), !dbg !4609 ; [debug line = 28:57@101:9] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %data.assign}, i64 0, metadata !4610), !dbg !4613 ; [debug line = 252:55@31:2@101:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %data.assign}, i64 0, metadata !4614), !dbg !4616 ; [debug line = 252:55@252:77@31:2@101:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %mat_out.V.data.V}, i64 0, metadata !4617), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.keep.V}, i64 0, metadata !4621), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.strb.V}, i64 0, metadata !4622), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.user.V}, i64 0, metadata !4623), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.last.V}, i64 0, metadata !4624), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.id.V}, i64 0, metadata !4625), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.dest.V}, i64 0, metadata !4626), !dbg !4619 ; [debug line = 144:48@102:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V.3}, metadata !4627), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V.3}, metadata !4631), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V.3}, metadata !4632), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V.3}, metadata !4633), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V.3}, metadata !4634), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V.3}, metadata !4635), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V.3}, metadata !4636), !dbg !4630 ; [debug line = 145:22@102:9] [debug variable = tmp.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign}, i64 0, metadata !4627), !dbg !4637 ; [debug line = 145:31@102:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign}, i64 0, metadata !4627), !dbg !4637 ; [debug line = 145:31@102:9] [debug variable = tmp.data.V]
  store i32 %data.assign, i32* %tmp.data.V.3, align 4, !dbg !4637 ; [debug line = 145:31@102:9]
  store i4 -1, i4* %tmp.keep.V.3, align 4, !dbg !4637 ; [debug line = 145:31@102:9]
  store i4 -1, i4* %tmp.strb.V.3, align 1, !dbg !4637 ; [debug line = 145:31@102:9]
  store i1 false, i1* %tmp.user.V.3, align 2, !dbg !4637 ; [debug line = 145:31@102:9]
  store i1 false, i1* %tmp.last.V.3, align 1, !dbg !4637 ; [debug line = 145:31@102:9]
  store i1 false, i1* %tmp.id.V.3, align 4, !dbg !4637 ; [debug line = 145:31@102:9]
  store i1 false, i1* %tmp.dest.V.3, align 1, !dbg !4637 ; [debug line = 145:31@102:9]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_out.V.data.V, i4* %mat_out.V.keep.V, i4* %mat_out.V.strb.V, i1* %mat_out.V.user.V, i1* %mat_out.V.last.V, i1* %mat_out.V.id.V, i1* %mat_out.V.dest.V, i32* %tmp.data.V.3, i4* %tmp.keep.V.3, i4* %tmp.strb.V.3, i1* %tmp.user.V.3, i1* %tmp.last.V.3, i1* %tmp.id.V.3, i1* %tmp.dest.V.3), !dbg !4638 ; [debug line = 146:9@102:9]
  %i.12 = add i4 %i3, 1, !dbg !4639               ; [#uses=1 type=i4] [debug line = 99:22]
  call void @llvm.dbg.value(metadata !{i4 %i.12}, i64 0, metadata !4640), !dbg !4639 ; [debug line = 99:22] [debug variable = i]
  br label %.preheader16, !dbg !4639              ; [debug line = 99:22]

.preheader15:                                     ; preds = %20, %.preheader15.preheader
  %i4 = phi i4 [ %i.13, %20 ], [ 0, %.preheader15.preheader ] ; [#uses=3 type=i4]
  %exitcond3 = icmp eq i4 %i4, -7, !dbg !4604     ; [#uses=1 type=i1] [debug line = 105:16]
  %19 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %.preheader.preheader, label %20, !dbg !4604 ; [debug line = 105:16]

.preheader.preheader:                             ; preds = %.preheader15
  br label %.preheader, !dbg !4641                ; [debug line = 112:16]

; <label>:20                                      ; preds = %.preheader15
  %tmp.20 = zext i4 %i4 to i64, !dbg !4643        ; [#uses=1 type=i64] [debug line = 107:9]
  %cell_avg.green.addr.1 = getelementptr [9 x i32]* %cell_avg.green, i64 0, i64 %tmp.20, !dbg !4643 ; [#uses=1 type=i32*] [debug line = 107:9]
  %data.assign.1 = load i32* %cell_avg.green.addr.1, align 4, !dbg !4643 ; [#uses=1 type=i32] [debug line = 107:9]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.1}, i64 0, metadata !4645), !dbg !4646 ; [debug line = 28:57@107:9] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.1}, i64 0, metadata !4647), !dbg !4649 ; [debug line = 252:55@31:2@107:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.1}, i64 0, metadata !4650), !dbg !4652 ; [debug line = 252:55@252:77@31:2@107:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %mat_out.V.data.V}, i64 0, metadata !4617), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.keep.V}, i64 0, metadata !4621), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.strb.V}, i64 0, metadata !4622), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.user.V}, i64 0, metadata !4623), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.last.V}, i64 0, metadata !4624), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.id.V}, i64 0, metadata !4625), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.dest.V}, i64 0, metadata !4626), !dbg !4653 ; [debug line = 144:48@108:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V.4}, metadata !4627), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V.4}, metadata !4631), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V.4}, metadata !4632), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V.4}, metadata !4633), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V.4}, metadata !4634), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V.4}, metadata !4635), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V.4}, metadata !4636), !dbg !4655 ; [debug line = 145:22@108:9] [debug variable = tmp.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.1}, i64 0, metadata !4627), !dbg !4656 ; [debug line = 145:31@108:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.1}, i64 0, metadata !4627), !dbg !4656 ; [debug line = 145:31@108:9] [debug variable = tmp.data.V]
  store i32 %data.assign.1, i32* %tmp.data.V.4, align 4, !dbg !4656 ; [debug line = 145:31@108:9]
  store i4 -1, i4* %tmp.keep.V.4, align 4, !dbg !4656 ; [debug line = 145:31@108:9]
  store i4 -1, i4* %tmp.strb.V.4, align 1, !dbg !4656 ; [debug line = 145:31@108:9]
  store i1 false, i1* %tmp.user.V.4, align 2, !dbg !4656 ; [debug line = 145:31@108:9]
  store i1 false, i1* %tmp.last.V.4, align 1, !dbg !4656 ; [debug line = 145:31@108:9]
  store i1 false, i1* %tmp.id.V.4, align 4, !dbg !4656 ; [debug line = 145:31@108:9]
  store i1 false, i1* %tmp.dest.V.4, align 1, !dbg !4656 ; [debug line = 145:31@108:9]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_out.V.data.V, i4* %mat_out.V.keep.V, i4* %mat_out.V.strb.V, i1* %mat_out.V.user.V, i1* %mat_out.V.last.V, i1* %mat_out.V.id.V, i1* %mat_out.V.dest.V, i32* %tmp.data.V.4, i4* %tmp.keep.V.4, i4* %tmp.strb.V.4, i1* %tmp.user.V.4, i1* %tmp.last.V.4, i1* %tmp.id.V.4, i1* %tmp.dest.V.4), !dbg !4657 ; [debug line = 146:9@108:9]
  %i.13 = add i4 %i4, 1, !dbg !4658               ; [#uses=1 type=i4] [debug line = 105:22]
  call void @llvm.dbg.value(metadata !{i4 %i.13}, i64 0, metadata !4659), !dbg !4658 ; [debug line = 105:22] [debug variable = i]
  br label %.preheader15, !dbg !4658              ; [debug line = 105:22]

.preheader:                                       ; preds = %22, %.preheader.preheader
  %i6 = phi i4 [ %i.14, %22 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i4]
  %exitcond = icmp eq i4 %i6, -7, !dbg !4641      ; [#uses=1 type=i1] [debug line = 112:16]
  %21 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 9, i64 9, i64 9) ; [#uses=0 type=i32]
  br i1 %exitcond, label %23, label %22, !dbg !4641 ; [debug line = 112:16]

; <label>:22                                      ; preds = %.preheader
  %tmp.21 = zext i4 %i6 to i64, !dbg !4660        ; [#uses=1 type=i64] [debug line = 114:9]
  %cell_avg.blue.addr.1 = getelementptr [9 x i32]* %cell_avg.blue, i64 0, i64 %tmp.21, !dbg !4660 ; [#uses=1 type=i32*] [debug line = 114:9]
  %data.assign.2 = load i32* %cell_avg.blue.addr.1, align 4, !dbg !4660 ; [#uses=1 type=i32] [debug line = 114:9]
  %tmp.last.V.6 = icmp eq i4 %i6, -8, !dbg !4660  ; [#uses=1 type=i1] [debug line = 114:9]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.2}, i64 0, metadata !4662), !dbg !4663 ; [debug line = 28:57@114:9] [debug variable = data]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.2}, i64 0, metadata !4664), !dbg !4666 ; [debug line = 252:55@31:2@114:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.2}, i64 0, metadata !4667), !dbg !4669 ; [debug line = 252:55@252:77@31:2@114:9] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %mat_out.V.data.V}, i64 0, metadata !4617), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.keep.V}, i64 0, metadata !4621), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %mat_out.V.strb.V}, i64 0, metadata !4622), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.user.V}, i64 0, metadata !4623), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.last.V}, i64 0, metadata !4624), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.id.V}, i64 0, metadata !4625), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i1* %mat_out.V.dest.V}, i64 0, metadata !4626), !dbg !4670 ; [debug line = 144:48@115:9] [debug variable = stream<ap_axiu<32, 1, 1, 1> >.V.dest.V]
  call void @llvm.dbg.declare(metadata !{i32* %tmp.data.V.5}, metadata !4627), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.keep.V.5}, metadata !4631), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.keep.V]
  call void @llvm.dbg.declare(metadata !{i4* %tmp.strb.V.5}, metadata !4632), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.strb.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.user.V.5}, metadata !4633), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.user.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.last.V.5}, metadata !4634), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.last.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.id.V.5}, metadata !4635), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.id.V]
  call void @llvm.dbg.declare(metadata !{i1* %tmp.dest.V.5}, metadata !4636), !dbg !4672 ; [debug line = 145:22@115:9] [debug variable = tmp.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.2}, i64 0, metadata !4627), !dbg !4673 ; [debug line = 145:31@115:9] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %data.assign.2}, i64 0, metadata !4627), !dbg !4673 ; [debug line = 145:31@115:9] [debug variable = tmp.data.V]
  store i32 %data.assign.2, i32* %tmp.data.V.5, align 4, !dbg !4673 ; [debug line = 145:31@115:9]
  store i4 -1, i4* %tmp.keep.V.5, align 4, !dbg !4673 ; [debug line = 145:31@115:9]
  store i4 -1, i4* %tmp.strb.V.5, align 1, !dbg !4673 ; [debug line = 145:31@115:9]
  store i1 false, i1* %tmp.user.V.5, align 2, !dbg !4673 ; [debug line = 145:31@115:9]
  call void @llvm.dbg.value(metadata !{i1 %tmp.last.V.6}, i64 0, metadata !4634), !dbg !4673 ; [debug line = 145:31@115:9] [debug variable = tmp.last.V]
  call void @llvm.dbg.value(metadata !{i1 %tmp.last.V.6}, i64 0, metadata !4634), !dbg !4673 ; [debug line = 145:31@115:9] [debug variable = tmp.last.V]
  store i1 %tmp.last.V.6, i1* %tmp.last.V.5, align 1, !dbg !4673 ; [debug line = 145:31@115:9]
  store i1 false, i1* %tmp.id.V.5, align 4, !dbg !4673 ; [debug line = 145:31@115:9]
  store i1 false, i1* %tmp.dest.V.5, align 1, !dbg !4673 ; [debug line = 145:31@115:9]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32* %mat_out.V.data.V, i4* %mat_out.V.keep.V, i4* %mat_out.V.strb.V, i1* %mat_out.V.user.V, i1* %mat_out.V.last.V, i1* %mat_out.V.id.V, i1* %mat_out.V.dest.V, i32* %tmp.data.V.5, i4* %tmp.keep.V.5, i4* %tmp.strb.V.5, i1* %tmp.user.V.5, i1* %tmp.last.V.5, i1* %tmp.id.V.5, i1* %tmp.dest.V.5), !dbg !4674 ; [debug line = 146:9@115:9]
  %i.14 = add i4 %i6, 1, !dbg !4675               ; [#uses=1 type=i4] [debug line = 112:22]
  call void @llvm.dbg.value(metadata !{i4 %i.14}, i64 0, metadata !4676), !dbg !4675 ; [debug line = 112:22] [debug variable = i]
  br label %.preheader, !dbg !4675                ; [debug line = 112:22]

; <label>:23                                      ; preds = %.preheader
  ret void, !dbg !4677                            ; [debug line = 119:5]
}
...
; [#uses=3]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*)

; [#uses=3]
declare void @"_ssdm_op_IfRead.Stream.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P.%struct.ap_axiu.33 = type { %struct.ap_uint.26, %struct.ap_uint.0.29, %struct.ap_uint.0.29, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32, %struct.ap_uint.3.32 }P"(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*)

; [#uses=1]
declare void @_GLOBAL__I_a() nounwind section ".text.startup"

!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!4328, !4335, !4341, !4347, !4347, !4350, !4350, !4356, !4347, !4347, !4350, !4350, !4359, !4347, !4347, !4350, !4350, !4361, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350, !4350}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!4363}
...
!901 = metadata !{i32 786478, i32 0, metadata !902, metadata !"matrixAvg", metadata !"matrixAvg", metadata !"_Z9matrixAvgRN3hls6streamI7ap_axiuILi32ELi1ELi1ELi1EEEES4_", metadata !902, i32 41, metadata !903, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 41} ; [ DW_TAG_subprogram ]
...
!2590 = metadata !{i32 786478, i32 0, metadata !907, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI7ap_axiuILi32ELi1ELi1ELi1EEE5writeERKS2_", metadata !908, i32 144, metadata !2565, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2581, metadata !89, i32 144} ; [ DW_TAG_subprogram ]
!2591 = metadata !{i32 786478, i32 0, metadata !902, metadata !"set_data_axis<int>", metadata !"set_data_axis<int>", metadata !"_Z13set_data_axisIiEvR7ap_axiuILi32ELi1ELi1ELi1EET_i", metadata !902, i32 28, metadata !2592, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !2596, null, metadata !89, i32 29} ; [ DW_TAG_subprogram ]
...
!2598 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC1Ei", metadata !916, i32 252, metadata !2150, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2149, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2599 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC2Ei", metadata !916, i32 252, metadata !2150, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2149, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2600 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi4ELb0ELb1EEC2Ev", metadata !891, i32 1439, metadata !1633, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1632, metadata !89, i32 1439} ; [ DW_TAG_subprogram ]
!2601 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi4ELb0EEC2Ev", metadata !923, i32 6, metadata !1629, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1628, metadata !89, i32 6} ; [ DW_TAG_subprogram ]
!2602 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi4EEaSERKS0_", metadata !916, i32 279, metadata !2194, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2193, metadata !89, i32 279} ; [ DW_TAG_subprogram ]
!2603 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ei", metadata !916, i32 252, metadata !2485, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2484, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2604 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ei", metadata !916, i32 252, metadata !2485, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2484, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2605 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi1ELb0ELb1EEC2Ev", metadata !891, i32 1439, metadata !2214, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2213, metadata !89, i32 1439} ; [ DW_TAG_subprogram ]
!2606 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi1ELb0EEC2Ev", metadata !923, i32 3, metadata !2210, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2209, metadata !89, i32 3} ; [ DW_TAG_subprogram ]
!2607 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi1EEaSERKS0_", metadata !916, i32 279, metadata !2529, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2528, metadata !89, i32 279} ; [ DW_TAG_subprogram ]
!2608 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC1Ei", metadata !916, i32 252, metadata !1570, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1569, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2609 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC2Ei", metadata !916, i32 252, metadata !1570, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1569, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!2610 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb0ELb1EEC2Ev", metadata !891, i32 1439, metadata !935, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !934, metadata !89, i32 1439} ; [ DW_TAG_subprogram ]
!2611 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi32ELb0EEC2Ev", metadata !923, i32 34, metadata !928, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !927, metadata !89, i32 34} ; [ DW_TAG_subprogram ]
!2612 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi32EEaSERKS0_", metadata !916, i32 279, metadata !1614, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1613, metadata !89, i32 279} ; [ DW_TAG_subprogram ]
!2613 = metadata !{i32 786478, i32 0, null, metadata !"to_uint", metadata !"to_uint", metadata !"_ZNK11ap_int_baseILi32ELb0ELb1EE7to_uintEv", metadata !891, i32 1667, metadata !1088, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1087, metadata !89, i32 1667} ; [ DW_TAG_subprogram ]
!2614 = metadata !{i32 786478, i32 0, metadata !907, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI7ap_axiuILi32ELi1ELi1ELi1EEE4readEv", metadata !908, i32 129, metadata !2576, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2575, metadata !89, i32 129} ; [ DW_TAG_subprogram ]
!2615 = metadata !{i32 786478, i32 0, null, metadata !"ap_axiu", metadata !"ap_axiu", metadata !"_ZN7ap_axiuILi32ELi1ELi1ELi1EEC1Ev", metadata !912, i32 100, metadata !2536, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !2539, metadata !89, i32 100} ; [ DW_TAG_subprogram ]
!2616 = metadata !{i32 786478, i32 0, null, metadata !"ap_axiu", metadata !"ap_axiu", metadata !"_ZN7ap_axiuILi32ELi1ELi1ELi1EEC2Ev", metadata !912, i32 100, metadata !2536, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !2539, metadata !89, i32 100} ; [ DW_TAG_subprogram ]
!2617 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ev", metadata !916, i32 185, metadata !2451, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2450, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
!2618 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ev", metadata !916, i32 185, metadata !2451, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2450, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
!2619 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC1Ev", metadata !916, i32 185, metadata !2116, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2115, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
!2620 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi4EEC2Ev", metadata !916, i32 185, metadata !2116, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2115, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
!2621 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC1Ev", metadata !916, i32 185, metadata !1536, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1535, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
!2622 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC2Ev", metadata !916, i32 185, metadata !1536, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1535, metadata !89, i32 185} ; [ DW_TAG_subprogram ]
...
!2673 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !2675, i32 74, metadata !2676, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!2689 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !2690, i32 149, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2690 = metadata !{i32 786473, metadata !"/usr/include/math.h", metadata !"/home/users/qi.zhou/Desktop", null} ; [ DW_TAG_file_type ]
!2691 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !2692, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2693 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !2692, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2694 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !2692, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2695 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !2692, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2696 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !2697, i32 283, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2697 = metadata !{i32 786473, metadata !"/usr/include/time.h", metadata !"/home/users/qi.zhou/Desktop", null} ; [ DW_TAG_file_type ]
!2698 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !2697, i32 297, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2699 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !2697, i32 403, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2700 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !2701, i32 58, metadata !213, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2701 = metadata !{i32 786473, metadata !"/usr/include/getopt.h", metadata !"/home/users/qi.zhou/Desktop", null} ; [ DW_TAG_file_type ]
!2702 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !2701, i32 72, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2703 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !2701, i32 77, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2704 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !2701, i32 81, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2705 = metadata !{i32 786484, i32 0, metadata !2706, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !2707, i32 70, metadata !2708, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2710 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !2711, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2713 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !2711, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2714 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2715 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2716 = metadata !{i32 786484, i32 0, metadata !2676, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2717 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !2718, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2821 = metadata !{i32 786484, i32 0, metadata !2736, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !2718, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2822 = metadata !{i32 786484, i32 0, metadata !2823, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !2718, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2955 = metadata !{i32 786484, i32 0, metadata !2956, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !2718, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2962 = metadata !{i32 786484, i32 0, metadata !2956, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !2718, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2963 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !2718, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2964 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !2718, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2965 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !2718, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2966 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !2675, i32 60, metadata !2967, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3647 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !2675, i32 61, metadata !3648, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3649 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !2675, i32 62, metadata !3648, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3650 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !2675, i32 63, metadata !3648, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3651 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !2675, i32 66, metadata !3652, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4324 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !2675, i32 67, metadata !4325, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!4326 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !2675, i32 68, metadata !4325, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4327 = metadata !{i32 786484, i32 0, metadata !2674, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !2675, i32 69, metadata !4325, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!4328 = metadata !{null, metadata !4329, metadata !4330, metadata !4331, metadata !4332, metadata !4333, metadata !4334}
...
!4335 = metadata !{null, metadata !4336, metadata !4337, metadata !4338, metadata !4339, metadata !4340, metadata !4334}
...
!4341 = metadata !{null, metadata !4342, metadata !4343, metadata !4344, metadata !4345, metadata !4346, metadata !4334}
...
!4347 = metadata !{null, metadata !4336, metadata !4337, metadata !4348, metadata !4339, metadata !4349, metadata !4334}
!4348 = metadata !{metadata !"kernel_arg_type", metadata !"int"}
!4349 = metadata !{metadata !"kernel_arg_name", metadata !"val"}
!4350 = metadata !{null, metadata !4351, metadata !4352, metadata !4353, metadata !4354, metadata !4355, metadata !4334}
!4351 = metadata !{metadata !"kernel_arg_addr_space"}
!4352 = metadata !{metadata !"kernel_arg_access_qual"}
!4353 = metadata !{metadata !"kernel_arg_type"}
!4354 = metadata !{metadata !"kernel_arg_type_qual"}
!4355 = metadata !{metadata !"kernel_arg_name"}
!4356 = metadata !{null, metadata !4336, metadata !4337, metadata !4357, metadata !4339, metadata !4358, metadata !4334}
!4357 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<4> &"}
!4358 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!4359 = metadata !{null, metadata !4336, metadata !4337, metadata !4360, metadata !4339, metadata !4358, metadata !4334}
!4360 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<1> &"}
!4361 = metadata !{null, metadata !4336, metadata !4337, metadata !4362, metadata !4339, metadata !4358, metadata !4334}
!4362 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<32> &"}
!4363 = metadata !{metadata !4364, [1 x i32]* @llvm.global_ctors.0}
!4364 = metadata !{metadata !4365}
!4365 = metadata !{i32 0, i32 31, metadata !4366}
!4366 = metadata !{metadata !4367}
!4367 = metadata !{metadata !"llvm.global_ctors.0", metadata !4368, metadata !"", i32 0, i32 31}
!4368 = metadata !{metadata !4369}
!4369 = metadata !{i32 0, i32 0, i32 1}
!4370 = metadata !{metadata !4371}
!4371 = metadata !{i32 0, i32 31, metadata !4372}
!4372 = metadata !{metadata !4373}
!4373 = metadata !{metadata !"mat_in.V.data.V", metadata !4368, metadata !"uint32", i32 0, i32 31}
!4374 = metadata !{metadata !4375}
!4375 = metadata !{i32 0, i32 3, metadata !4376}
!4376 = metadata !{metadata !4377}
!4377 = metadata !{metadata !"mat_in.V.keep.V", metadata !4368, metadata !"uint4", i32 0, i32 3}
!4378 = metadata !{metadata !4379}
!4379 = metadata !{i32 0, i32 3, metadata !4380}
!4380 = metadata !{metadata !4381}
!4381 = metadata !{metadata !"mat_in.V.strb.V", metadata !4368, metadata !"uint4", i32 0, i32 3}
!4382 = metadata !{metadata !4383}
!4383 = metadata !{i32 0, i32 0, metadata !4384}
!4384 = metadata !{metadata !4385}
!4385 = metadata !{metadata !"mat_in.V.user.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4386 = metadata !{metadata !4387}
!4387 = metadata !{i32 0, i32 0, metadata !4388}
!4388 = metadata !{metadata !4389}
!4389 = metadata !{metadata !"mat_in.V.last.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4390 = metadata !{metadata !4391}
!4391 = metadata !{i32 0, i32 0, metadata !4392}
!4392 = metadata !{metadata !4393}
!4393 = metadata !{metadata !"mat_in.V.id.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4394 = metadata !{metadata !4395}
!4395 = metadata !{i32 0, i32 0, metadata !4396}
!4396 = metadata !{metadata !4397}
!4397 = metadata !{metadata !"mat_in.V.dest.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4398 = metadata !{metadata !4399}
!4399 = metadata !{i32 0, i32 31, metadata !4400}
!4400 = metadata !{metadata !4401}
!4401 = metadata !{metadata !"mat_out.V.data.V", metadata !4368, metadata !"uint32", i32 0, i32 31}
!4402 = metadata !{metadata !4403}
!4403 = metadata !{i32 0, i32 3, metadata !4404}
!4404 = metadata !{metadata !4405}
!4405 = metadata !{metadata !"mat_out.V.keep.V", metadata !4368, metadata !"uint4", i32 0, i32 3}
!4406 = metadata !{metadata !4407}
!4407 = metadata !{i32 0, i32 3, metadata !4408}
!4408 = metadata !{metadata !4409}
!4409 = metadata !{metadata !"mat_out.V.strb.V", metadata !4368, metadata !"uint4", i32 0, i32 3}
!4410 = metadata !{metadata !4411}
!4411 = metadata !{i32 0, i32 0, metadata !4412}
!4412 = metadata !{metadata !4413}
!4413 = metadata !{metadata !"mat_out.V.user.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4414 = metadata !{metadata !4415}
!4415 = metadata !{i32 0, i32 0, metadata !4416}
!4416 = metadata !{metadata !4417}
!4417 = metadata !{metadata !"mat_out.V.last.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4418 = metadata !{metadata !4419}
!4419 = metadata !{i32 0, i32 0, metadata !4420}
!4420 = metadata !{metadata !4421}
!4421 = metadata !{metadata !"mat_out.V.id.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4422 = metadata !{metadata !4423}
!4423 = metadata !{i32 0, i32 0, metadata !4424}
!4424 = metadata !{metadata !4425}
!4425 = metadata !{metadata !"mat_out.V.dest.V", metadata !4368, metadata !"uint1", i32 0, i32 0}
!4426 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.data.V", null, i32 41, metadata !4428, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4427 = metadata !{i32 786689, metadata !901, metadata !"mat_in", metadata !902, i32 16777257, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4428 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !4429} ; [ DW_TAG_pointer_type ]
!4429 = metadata !{i32 786438, metadata !907, metadata !"stream<ap_axiu<32, 1, 1, 1> >", metadata !908, i32 79, i64 32, i64 32, i32 0, i32 0, null, metadata !4430, i32 0, null, metadata !2588} ; [ DW_TAG_class_field_type ]
!4430 = metadata !{metadata !4431}
!4431 = metadata !{i32 786438, null, metadata !"ap_axiu<32, 1, 1, 1>", metadata !912, i32 100, i64 32, i64 32, i32 0, i32 0, null, metadata !4432, i32 0, null, metadata !2540} ; [ DW_TAG_class_field_type ]
!4432 = metadata !{metadata !4433}
!4433 = metadata !{i32 786438, null, metadata !"ap_uint<32>", metadata !916, i32 182, i64 32, i64 32, i32 0, i32 0, null, metadata !4434, i32 0, null, metadata !1616} ; [ DW_TAG_class_field_type ]
!4434 = metadata !{metadata !4435}
!4435 = metadata !{i32 786438, null, metadata !"ap_int_base<32, false, true>", metadata !891, i32 1398, i64 32, i64 32, i32 0, i32 0, null, metadata !4436, i32 0, null, metadata !1534} ; [ DW_TAG_class_field_type ]
!4436 = metadata !{metadata !4437}
!4437 = metadata !{i32 786438, null, metadata !"ssdm_int<32 + 1024 * 0, false>", metadata !923, i32 34, i64 32, i64 32, i32 0, i32 0, null, metadata !4438, i32 0, null, metadata !931} ; [ DW_TAG_class_field_type ]
!4438 = metadata !{metadata !925}
!4439 = metadata !{i32 41, i32 40, metadata !901, null}
!4440 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.keep.V", null, i32 41, metadata !4441, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4441 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !4442} ; [ DW_TAG_pointer_type ]
!4442 = metadata !{i32 786438, metadata !907, metadata !"stream<ap_axiu<32, 1, 1, 1> >", metadata !908, i32 79, i64 4, i64 32, i32 0, i32 0, null, metadata !4443, i32 0, null, metadata !2588} ; [ DW_TAG_class_field_type ]
!4443 = metadata !{metadata !4444}
!4444 = metadata !{i32 786438, null, metadata !"ap_axiu<32, 1, 1, 1>", metadata !912, i32 100, i64 4, i64 32, i32 0, i32 0, null, metadata !4445, i32 0, null, metadata !2540} ; [ DW_TAG_class_field_type ]
!4445 = metadata !{metadata !4446}
!4446 = metadata !{i32 786438, null, metadata !"ap_uint<4>", metadata !916, i32 182, i64 4, i64 8, i32 0, i32 0, null, metadata !4447, i32 0, null, metadata !2196} ; [ DW_TAG_class_field_type ]
!4447 = metadata !{metadata !4448}
!4448 = metadata !{i32 786438, null, metadata !"ap_int_base<4, false, true>", metadata !891, i32 1398, i64 4, i64 8, i32 0, i32 0, null, metadata !4449, i32 0, null, metadata !2113} ; [ DW_TAG_class_field_type ]
!4449 = metadata !{metadata !4450}
!4450 = metadata !{i32 786438, null, metadata !"ssdm_int<4 + 1024 * 0, false>", metadata !923, i32 6, i64 4, i64 8, i32 0, i32 0, null, metadata !4451, i32 0, null, metadata !1066} ; [ DW_TAG_class_field_type ]
!4451 = metadata !{metadata !1626}
!4452 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.strb.V", null, i32 41, metadata !4441, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4453 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.user.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4454 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !4455} ; [ DW_TAG_pointer_type ]
!4455 = metadata !{i32 786438, metadata !907, metadata !"stream<ap_axiu<32, 1, 1, 1> >", metadata !908, i32 79, i64 1, i64 32, i32 0, i32 0, null, metadata !4456, i32 0, null, metadata !2588} ; [ DW_TAG_class_field_type ]
!4456 = metadata !{metadata !4457}
!4457 = metadata !{i32 786438, null, metadata !"ap_axiu<32, 1, 1, 1>", metadata !912, i32 100, i64 1, i64 32, i32 0, i32 0, null, metadata !4458, i32 0, null, metadata !2540} ; [ DW_TAG_class_field_type ]
!4458 = metadata !{metadata !4459}
!4459 = metadata !{i32 786438, null, metadata !"ap_uint<1>", metadata !916, i32 182, i64 1, i64 8, i32 0, i32 0, null, metadata !4460, i32 0, null, metadata !2531} ; [ DW_TAG_class_field_type ]
!4460 = metadata !{metadata !4461}
!4461 = metadata !{i32 786438, null, metadata !"ap_int_base<1, false, true>", metadata !891, i32 1398, i64 1, i64 8, i32 0, i32 0, null, metadata !4462, i32 0, null, metadata !2448} ; [ DW_TAG_class_field_type ]
!4462 = metadata !{metadata !4463}
!4463 = metadata !{i32 786438, null, metadata !"ssdm_int<1 + 1024 * 0, false>", metadata !923, i32 3, i64 1, i64 8, i32 0, i32 0, null, metadata !4464, i32 0, null, metadata !1751} ; [ DW_TAG_class_field_type ]
!4464 = metadata !{metadata !2207}
!4465 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.last.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4466 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.id.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4467 = metadata !{i32 790531, metadata !4427, metadata !"mat_in.V.dest.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4468 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.data.V", null, i32 41, metadata !4428, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4469 = metadata !{i32 786689, metadata !901, metadata !"mat_out", metadata !902, i32 33554473, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4470 = metadata !{i32 41, i32 72, metadata !901, null}
!4471 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.keep.V", null, i32 41, metadata !4441, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4472 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.strb.V", null, i32 41, metadata !4441, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4473 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.user.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4474 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.last.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4475 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.id.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4476 = metadata !{i32 790531, metadata !4469, metadata !"mat_out.V.dest.V", null, i32 41, metadata !4454, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4477 = metadata !{i32 43, i32 1, metadata !4478, null}
!4478 = metadata !{i32 786443, metadata !901, i32 41, i32 80, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!4479 = metadata !{i32 44, i32 1, metadata !4478, null}
!4480 = metadata !{i32 45, i32 1, metadata !4478, null}
!4481 = metadata !{i32 786688, metadata !4478, metadata !"red", metadata !902, i32 48, metadata !4482, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4482 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 28800, i64 32, i32 0, i32 0, metadata !56, metadata !4483, i32 0, i32 0} ; [ DW_TAG_array_type ]
!4483 = metadata !{metadata !4484}
!4484 = metadata !{i32 786465, i64 0, i64 899}    ; [ DW_TAG_subrange_type ]
!4485 = metadata !{i32 48, i32 6, metadata !4478, null}
!4486 = metadata !{i32 786688, metadata !4478, metadata !"green", metadata !902, i32 49, metadata !4482, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4487 = metadata !{i32 49, i32 9, metadata !4478, null}
!4488 = metadata !{i32 786688, metadata !4478, metadata !"blue", metadata !902, i32 50, metadata !4482, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4489 = metadata !{i32 50, i32 9, metadata !4478, null}
!4490 = metadata !{i32 790529, metadata !4491, metadata !"cell_avg.red", null, i32 51, metadata !4505, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4491 = metadata !{i32 786688, metadata !4478, metadata !"cell_avg", metadata !902, i32 51, metadata !4492, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4492 = metadata !{i32 786454, null, metadata !"Average", metadata !902, i32 21, i64 0, i64 0, i64 0, i32 0, metadata !4493} ; [ DW_TAG_typedef ]
!4493 = metadata !{i32 786434, null, metadata !"average", metadata !902, i32 17, i64 864, i64 32, i32 0, i32 0, null, metadata !4494, i32 0, null, null} ; [ DW_TAG_class_type ]
!4494 = metadata !{metadata !4495, metadata !4499, metadata !4500, metadata !4501}
!4495 = metadata !{i32 786445, metadata !4493, metadata !"red", metadata !902, i32 18, i64 288, i64 32, i64 0, i32 0, metadata !4496} ; [ DW_TAG_member ]
!4496 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 288, i64 32, i32 0, i32 0, metadata !56, metadata !4497, i32 0, i32 0} ; [ DW_TAG_array_type ]
!4497 = metadata !{metadata !4498}
!4498 = metadata !{i32 786465, i64 0, i64 8}      ; [ DW_TAG_subrange_type ]
!4499 = metadata !{i32 786445, metadata !4493, metadata !"blue", metadata !902, i32 19, i64 288, i64 32, i64 288, i32 0, metadata !4496} ; [ DW_TAG_member ]
!4500 = metadata !{i32 786445, metadata !4493, metadata !"green", metadata !902, i32 20, i64 288, i64 32, i64 576, i32 0, metadata !4496} ; [ DW_TAG_member ]
!4501 = metadata !{i32 786478, i32 0, metadata !4493, metadata !"average", metadata !"average", metadata !"", metadata !902, i32 17, metadata !4502, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !89, i32 17} ; [ DW_TAG_subprogram ]
...
!4503 = metadata !{null, metadata !4504}
!4504 = metadata !{i32 786447, i32 0, metadata !"", i32 0, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !4493} ; [ DW_TAG_pointer_type ]
!4505 = metadata !{i32 786438, null, metadata !"average", metadata !902, i32 17, i64 288, i64 32, i32 0, i32 0, null, metadata !4506, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!4506 = metadata !{metadata !4495}
!4507 = metadata !{i32 51, i32 13, metadata !4478, null}
!4508 = metadata !{i32 790529, metadata !4491, metadata !"cell_avg.blue", null, i32 51, metadata !4509, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4509 = metadata !{i32 786438, null, metadata !"average", metadata !902, i32 17, i64 288, i64 32, i32 0, i32 0, null, metadata !4510, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!4510 = metadata !{metadata !4499}
!4511 = metadata !{i32 790529, metadata !4491, metadata !"cell_avg.green", null, i32 51, metadata !4512, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4512 = metadata !{i32 786438, null, metadata !"average", metadata !902, i32 17, i64 288, i64 32, i32 0, i32 0, null, metadata !4513, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!4513 = metadata !{metadata !4500}
!4514 = metadata !{i32 786688, metadata !4478, metadata !"sum_red", metadata !902, i32 54, metadata !4496, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4515 = metadata !{i32 54, i32 9, metadata !4478, null}
!4516 = metadata !{i32 786688, metadata !4478, metadata !"sum_blue", metadata !902, i32 55, metadata !4496, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4517 = metadata !{i32 55, i32 9, metadata !4478, null}
!4518 = metadata !{i32 786688, metadata !4478, metadata !"sum_green", metadata !902, i32 56, metadata !4496, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4519 = metadata !{i32 56, i32 9, metadata !4478, null}
!4520 = metadata !{i32 59, i32 9, metadata !4521, null}
!4521 = metadata !{i32 786443, metadata !4478, i32 59, i32 5, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!4522 = metadata !{i32 66, i32 9, metadata !4523, null}
!4523 = metadata !{i32 786443, metadata !4478, i32 66, i32 5, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!4524 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.data.V", null, i32 129, metadata !4527, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4525 = metadata !{i32 786689, metadata !2614, metadata !"this", metadata !908, i32 16777345, metadata !4526, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4526 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !906} ; [ DW_TAG_pointer_type ]
!4527 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !4429} ; [ DW_TAG_pointer_type ]
!4528 = metadata !{i32 129, i32 56, metadata !2614, metadata !4529}
!4529 = metadata !{i32 61, i32 29, metadata !4530, null}
!4530 = metadata !{i32 786443, metadata !4521, i32 59, i32 23, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!4531 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.keep.V", null, i32 129, metadata !4532, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4532 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !4442} ; [ DW_TAG_pointer_type ]
!4533 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.strb.V", null, i32 129, metadata !4532, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4534 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.user.V", null, i32 129, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4535 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !4455} ; [ DW_TAG_pointer_type ]
!4536 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.last.V", null, i32 129, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4537 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.id.V", null, i32 129, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4538 = metadata !{i32 790531, metadata !4525, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.dest.V", null, i32 129, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4539 = metadata !{i32 790529, metadata !4540, metadata !"tmp.data.V", null, i32 130, metadata !4431, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4540 = metadata !{i32 786688, metadata !4541, metadata !"tmp", metadata !908, i32 130, metadata !2563, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4541 = metadata !{i32 786443, metadata !2614, i32 129, i32 63, metadata !908, i32 36} ; [ DW_TAG_lexical_block ]
!4542 = metadata !{i32 130, i32 22, metadata !4541, metadata !4529}
!4543 = metadata !{i32 790529, metadata !4540, metadata !"tmp.keep.V", null, i32 130, metadata !4444, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4544 = metadata !{i32 790529, metadata !4540, metadata !"tmp.strb.V", null, i32 130, metadata !4444, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4545 = metadata !{i32 790529, metadata !4540, metadata !"tmp.user.V", null, i32 130, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4546 = metadata !{i32 790529, metadata !4540, metadata !"tmp.last.V", null, i32 130, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4547 = metadata !{i32 790529, metadata !4540, metadata !"tmp.id.V", null, i32 130, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4548 = metadata !{i32 790529, metadata !4540, metadata !"tmp.dest.V", null, i32 130, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4549 = metadata !{i32 131, i32 9, metadata !4541, metadata !4529}
!4550 = metadata !{i32 1667, i32 70, metadata !4551, metadata !4529}
!4551 = metadata !{i32 786443, metadata !2613, i32 1667, i32 68, metadata !891, i32 35} ; [ DW_TAG_lexical_block ]
!4552 = metadata !{i32 63, i32 9, metadata !4530, null}
!4553 = metadata !{i32 59, i32 19, metadata !4521, null}
!4554 = metadata !{i32 786688, metadata !4478, metadata !"i", metadata !902, i32 53, metadata !976, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4555 = metadata !{i32 72, i32 9, metadata !4556, null}
!4556 = metadata !{i32 786443, metadata !4478, i32 72, i32 5, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!4557 = metadata !{i32 129, i32 56, metadata !2614, metadata !4558}
!4558 = metadata !{i32 68, i32 29, metadata !4559, null}
!4559 = metadata !{i32 786443, metadata !4523, i32 66, i32 23, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!4560 = metadata !{i32 130, i32 22, metadata !4541, metadata !4558}
!4561 = metadata !{i32 131, i32 9, metadata !4541, metadata !4558}
!4562 = metadata !{i32 1667, i32 70, metadata !4551, metadata !4558}
!4563 = metadata !{i32 69, i32 9, metadata !4559, null}
!4564 = metadata !{i32 66, i32 19, metadata !4523, null}
!4565 = metadata !{i32 78, i32 9, metadata !4566, null}
!4566 = metadata !{i32 786443, metadata !4567, i32 77, i32 21, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!4567 = metadata !{i32 786443, metadata !4478, i32 77, i32 5, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!4568 = metadata !{i32 79, i32 9, metadata !4566, null}
!4569 = metadata !{i32 80, i32 9, metadata !4566, null}
!4570 = metadata !{i32 77, i32 9, metadata !4567, null}
!4571 = metadata !{i32 129, i32 56, metadata !2614, metadata !4572}
!4572 = metadata !{i32 74, i32 29, metadata !4573, null}
!4573 = metadata !{i32 786443, metadata !4556, i32 72, i32 23, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!4574 = metadata !{i32 130, i32 22, metadata !4541, metadata !4572}
!4575 = metadata !{i32 131, i32 9, metadata !4541, metadata !4572}
!4576 = metadata !{i32 1667, i32 70, metadata !4551, metadata !4572}
!4577 = metadata !{i32 75, i32 9, metadata !4573, null}
!4578 = metadata !{i32 72, i32 19, metadata !4556, null}
!4579 = metadata !{i32 86, i32 2, metadata !4580, null}
!4580 = metadata !{i32 786443, metadata !4581, i32 84, i32 27, metadata !902, i32 12} ; [ DW_TAG_lexical_block ]
!4581 = metadata !{i32 786443, metadata !4582, i32 84, i32 9, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!4582 = metadata !{i32 786443, metadata !4583, i32 83, i32 21, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!4583 = metadata !{i32 786443, metadata !4478, i32 83, i32 5, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!4584 = metadata !{i32 77, i32 17, metadata !4567, null}
!4585 = metadata !{i32 83, i32 9, metadata !4583, null}
!4586 = metadata !{i32 92, i32 9, metadata !4587, null}
!4587 = metadata !{i32 786443, metadata !4478, i32 92, i32 5, metadata !902, i32 13} ; [ DW_TAG_lexical_block ]
!4588 = metadata !{i32 87, i32 13, metadata !4580, null}
!4589 = metadata !{i32 88, i32 13, metadata !4580, null}
!4590 = metadata !{i32 84, i32 13, metadata !4581, null}
!4591 = metadata !{i32 84, i32 28, metadata !4580, null}
!4592 = metadata !{i32 85, i32 1, metadata !4580, null}
!4593 = metadata !{i32 89, i32 9, metadata !4580, null}
!4594 = metadata !{i32 84, i32 23, metadata !4581, null}
!4595 = metadata !{i32 83, i32 17, metadata !4583, null}
!4596 = metadata !{i32 786688, metadata !4478, metadata !"j", metadata !902, i32 57, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4597 = metadata !{i32 99, i32 16, metadata !4598, null}
!4598 = metadata !{i32 786443, metadata !4478, i32 99, i32 5, metadata !902, i32 15} ; [ DW_TAG_lexical_block ]
!4599 = metadata !{i32 93, i32 9, metadata !4600, null}
!4600 = metadata !{i32 786443, metadata !4587, i32 92, i32 21, metadata !902, i32 14} ; [ DW_TAG_lexical_block ]
!4601 = metadata !{i32 94, i32 9, metadata !4600, null}
!4602 = metadata !{i32 95, i32 9, metadata !4600, null}
!4603 = metadata !{i32 92, i32 17, metadata !4587, null}
!4604 = metadata !{i32 105, i32 16, metadata !4605, null}
!4605 = metadata !{i32 786443, metadata !4478, i32 105, i32 5, metadata !902, i32 17} ; [ DW_TAG_lexical_block ]
!4606 = metadata !{i32 101, i32 9, metadata !4607, null}
!4607 = metadata !{i32 786443, metadata !4598, i32 99, i32 26, metadata !902, i32 16} ; [ DW_TAG_lexical_block ]
!4608 = metadata !{i32 786689, metadata !2591, metadata !"data", metadata !902, i32 33554460, metadata !56, i32 0, metadata !4606} ; [ DW_TAG_arg_variable ]
!4609 = metadata !{i32 28, i32 57, metadata !2591, metadata !4606}
!4610 = metadata !{i32 786689, metadata !2608, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4611} ; [ DW_TAG_arg_variable ]
!4611 = metadata !{i32 31, i32 2, metadata !4612, metadata !4606}
!4612 = metadata !{i32 786443, metadata !2591, i32 29, i32 1, metadata !902, i32 22} ; [ DW_TAG_lexical_block ]
!4613 = metadata !{i32 252, i32 55, metadata !2608, metadata !4611}
!4614 = metadata !{i32 786689, metadata !2609, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4615} ; [ DW_TAG_arg_variable ]
!4615 = metadata !{i32 252, i32 77, metadata !2608, metadata !4611}
!4616 = metadata !{i32 252, i32 55, metadata !2609, metadata !4615}
!4617 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.data.V", null, i32 144, metadata !4527, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4618 = metadata !{i32 786689, metadata !2590, metadata !"this", metadata !908, i32 16777360, metadata !4526, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4619 = metadata !{i32 144, i32 48, metadata !2590, metadata !4620}
!4620 = metadata !{i32 102, i32 9, metadata !4607, null}
!4621 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.keep.V", null, i32 144, metadata !4532, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4622 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.strb.V", null, i32 144, metadata !4532, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4623 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.user.V", null, i32 144, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4624 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.last.V", null, i32 144, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4625 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.id.V", null, i32 144, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4626 = metadata !{i32 790531, metadata !4618, metadata !"stream<ap_axiu<32, 1, 1, 1> >.V.dest.V", null, i32 144, metadata !4535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!4627 = metadata !{i32 790529, metadata !4628, metadata !"tmp.data.V", null, i32 145, metadata !4431, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4628 = metadata !{i32 786688, metadata !4629, metadata !"tmp", metadata !908, i32 145, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4629 = metadata !{i32 786443, metadata !2590, i32 144, i32 79, metadata !908, i32 21} ; [ DW_TAG_lexical_block ]
!4630 = metadata !{i32 145, i32 22, metadata !4629, metadata !4620}
!4631 = metadata !{i32 790529, metadata !4628, metadata !"tmp.keep.V", null, i32 145, metadata !4444, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4632 = metadata !{i32 790529, metadata !4628, metadata !"tmp.strb.V", null, i32 145, metadata !4444, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4633 = metadata !{i32 790529, metadata !4628, metadata !"tmp.user.V", null, i32 145, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4634 = metadata !{i32 790529, metadata !4628, metadata !"tmp.last.V", null, i32 145, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4635 = metadata !{i32 790529, metadata !4628, metadata !"tmp.id.V", null, i32 145, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4636 = metadata !{i32 790529, metadata !4628, metadata !"tmp.dest.V", null, i32 145, metadata !4457, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!4637 = metadata !{i32 145, i32 31, metadata !4629, metadata !4620}
!4638 = metadata !{i32 146, i32 9, metadata !4629, metadata !4620}
!4639 = metadata !{i32 99, i32 22, metadata !4598, null}
!4640 = metadata !{i32 786688, metadata !4598, metadata !"i", metadata !902, i32 99, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4641 = metadata !{i32 112, i32 16, metadata !4642, null}
!4642 = metadata !{i32 786443, metadata !4478, i32 112, i32 5, metadata !902, i32 19} ; [ DW_TAG_lexical_block ]
!4643 = metadata !{i32 107, i32 9, metadata !4644, null}
!4644 = metadata !{i32 786443, metadata !4605, i32 105, i32 26, metadata !902, i32 18} ; [ DW_TAG_lexical_block ]
!4645 = metadata !{i32 786689, metadata !2591, metadata !"data", metadata !902, i32 33554460, metadata !56, i32 0, metadata !4643} ; [ DW_TAG_arg_variable ]
!4646 = metadata !{i32 28, i32 57, metadata !2591, metadata !4643}
!4647 = metadata !{i32 786689, metadata !2608, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4648} ; [ DW_TAG_arg_variable ]
!4648 = metadata !{i32 31, i32 2, metadata !4612, metadata !4643}
!4649 = metadata !{i32 252, i32 55, metadata !2608, metadata !4648}
!4650 = metadata !{i32 786689, metadata !2609, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4651} ; [ DW_TAG_arg_variable ]
!4651 = metadata !{i32 252, i32 77, metadata !2608, metadata !4648}
!4652 = metadata !{i32 252, i32 55, metadata !2609, metadata !4651}
!4653 = metadata !{i32 144, i32 48, metadata !2590, metadata !4654}
!4654 = metadata !{i32 108, i32 9, metadata !4644, null}
!4655 = metadata !{i32 145, i32 22, metadata !4629, metadata !4654}
!4656 = metadata !{i32 145, i32 31, metadata !4629, metadata !4654}
!4657 = metadata !{i32 146, i32 9, metadata !4629, metadata !4654}
!4658 = metadata !{i32 105, i32 22, metadata !4605, null}
!4659 = metadata !{i32 786688, metadata !4605, metadata !"i", metadata !902, i32 105, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4660 = metadata !{i32 114, i32 9, metadata !4661, null}
!4661 = metadata !{i32 786443, metadata !4642, i32 112, i32 26, metadata !902, i32 20} ; [ DW_TAG_lexical_block ]
!4662 = metadata !{i32 786689, metadata !2591, metadata !"data", metadata !902, i32 33554460, metadata !56, i32 0, metadata !4660} ; [ DW_TAG_arg_variable ]
!4663 = metadata !{i32 28, i32 57, metadata !2591, metadata !4660}
!4664 = metadata !{i32 786689, metadata !2608, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4665} ; [ DW_TAG_arg_variable ]
!4665 = metadata !{i32 31, i32 2, metadata !4612, metadata !4660}
!4666 = metadata !{i32 252, i32 55, metadata !2608, metadata !4665}
!4667 = metadata !{i32 786689, metadata !2609, metadata !"val", metadata !916, i32 33554684, metadata !56, i32 0, metadata !4668} ; [ DW_TAG_arg_variable ]
!4668 = metadata !{i32 252, i32 77, metadata !2608, metadata !4665}
!4669 = metadata !{i32 252, i32 55, metadata !2609, metadata !4668}
!4670 = metadata !{i32 144, i32 48, metadata !2590, metadata !4671}
!4671 = metadata !{i32 115, i32 9, metadata !4661, null}
!4672 = metadata !{i32 145, i32 22, metadata !4629, metadata !4671}
!4673 = metadata !{i32 145, i32 31, metadata !4629, metadata !4671}
!4674 = metadata !{i32 146, i32 9, metadata !4629, metadata !4671}
!4675 = metadata !{i32 112, i32 22, metadata !4642, null}
!4676 = metadata !{i32 786688, metadata !4642, metadata !"i", metadata !902, i32 112, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4677 = metadata !{i32 119, i32 5, metadata !4478, null}
